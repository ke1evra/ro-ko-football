    ...
    <div className="container mx-auto p-8">
      ...
      <div className="mt-8 p-4 bg-gray-100 rounded-lg">
        ...
        <ul className="text-sm space-y-1">
          <li>
            • <strong>Реальные страны</strong> (Germany, France, etc.) - должны показывать флаги
          </li>
          <li>
            • <strong>Турниры</strong> (Champions League, etc.) - должны показывать первую букву
            названия
          </li>
          <li>
            • <strong>Несуществующие ID</strong> - должны показывать заглушку после попытки загрузки
          </li>
          <li>
            • <strong>Ошибки загрузки</strong> - логируются только для реальных стран
          </li>
        </ul>
      </div>
    </div>
