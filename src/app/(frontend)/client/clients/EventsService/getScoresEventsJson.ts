...
import type { GetScoresEventsJsonQueryResponse, GetScoresEventsJsonQueryParams, GetScoresEventsJson400, GetScoresEventsJson401, GetScoresEventsJson404, GetScoresEventsJson500 } from "../../types/GetScoresEventsJson.ts";
 ...
 */
export async function getScoresEventsJson(params: GetScoresEventsJsonQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  const { client: request = fetch, ...requestConfig } = config  
  
  const res = await request<GetScoresEventsJsonQueryResponse, ResponseErrorConfig<GetScoresEventsJson400 | GetScoresEventsJson401 | GetScoresEventsJson404 | GetScoresEventsJson500>, unknown>({ method : "GET", url : getGetScoresEventsJsonUrl().url.toString(), params, ... requestConfig })  
  return res
}