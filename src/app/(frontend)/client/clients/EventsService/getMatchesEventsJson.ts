 ...
 */
export async function getMatchesEventsJson(
  params: GetMatchesEventsJsonQueryParams,
  ...
  const res = await request<
    ...
    >,
    unknown
  >({ method: 'GET', url: getGetMatchesEventsJsonUrl().url.toString(), params, ...requestConfig })
  return res
}
