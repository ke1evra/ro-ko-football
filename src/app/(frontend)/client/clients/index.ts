...
export { getGetTeamsLastmatchesJsonUrl, getTeamsLastmatchesJson } from "./CatalogsService/getTeamsLastmatchesJson.ts";
...
export { getGetMatchesEventsJsonUrl, getMatchesEventsJson } from "./EventsService/getMatchesEventsJson.ts";
...
export { getGetTeamsHead2HeadJsonUrl, getTeamsHead2HeadJson } from "./Lineups&StatsService/getTeamsHead2HeadJson.ts";
...
export { getGetOddsLiveJsonUrl, getOddsLiveJson } from "./OddsService/getOddsLiveJson.ts";
export { getGetOddsPreJsonUrl, getOddsPreJson } from "./OddsService/getOddsPreJson.ts";
export { oddsService } from "./OddsService/oddsService.ts";
...
export { getGetTranslationsCompetitionsJsonUrl, getTranslationsCompetitionsJson } from "./TranslationsService/getTranslationsCompetitionsJson.ts";
export { getGetTranslationsCountriesJsonUrl, getTranslationsCountriesJson } from "./TranslationsService/getTranslationsCountriesJson.ts";
export { getGetTranslationsFederationsJsonUrl, getTranslationsFederationsJson } from "./TranslationsService/getTranslationsFederationsJson.ts";
export { getGetTranslationsTeamsJsonUrl, getTranslationsTeamsJson } from "./TranslationsService/getTranslationsTeamsJson.ts";
export { translationsService } from "./TranslationsService/translationsService.ts";
export { getGetAuthVerifyJsonUrl, getAuthVerifyJson } from "./UtilityService/getAuthVerifyJson.ts";
export { getGetCountriesFlagJsonUrl, getCountriesFlagJson } from "./UtilityService/getCountriesFlagJson.ts";
