...
export type Match = {
    ...
    */
    ...
    /**
     * @description Отображение текущего игрового времени или стадии: число минут (идущая минута) л��бо специальные значения: `HT` (перерыв), `FT` (конец 90 минут), `AET` (после доп. времени), `AP` (после пенальти)
     * @type string
    */
