...
const styles = {
  typography: {
    base: [
      ...
      '[&_h3]:text-2xl sm:[&_h3]:text-3xl [&_h3]:tracking-tight',
      '[&_h4]:text-xl sm:[&_h4]:text-2xl [&_h4]:tracking-tight',
      '[&_h5]:text-lg sm:[&_h5]:text-xl [&_h5]:tracking-tight',
      '[&_h6]:text-base sm:[&_h6]:text-lg [&_h6]:tracking-tight',
      // Text elements
      '[&_p]:text-base sm:[&_p]:text-lg [&_p]:leading-7 [&_p]:mb-4',
      '[&_strong]:font-semibold',
      '[&_em]:italic',
      '[&_del]:line-through',
      '[&_small]:text-sm sm:[&_small]:text-base [&_small]:font-medium [&_small]:leading-none',
